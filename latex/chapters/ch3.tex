...
El objetivo de esta iteración fue incorporar al proyecto la estructura básica de la red de transporte público urbano de Toledo a partir de los datos GTFS. Con ello se buscaba ampliar el alcance del simulador más allá de la red viaria y comenzar a trabajar con una representación operativa del servicio de autobuses urbanos.

Este sprint permitió disponer de una primera capa de información de transporte público integrada en la aplicación y sentó la base necesaria para abordar posteriormente la planificación multimodal con OpenTripPlanner.
...
\subsection{Sprint 5: Diseño de una aplicación web para visualización y comparación modal}

\textbf{Fechas}: del 20 de diciembre de 2025 al 20 de febrero de 2026.

\textbf{Esfuerzo estimado}: 8--12 horas.

Este sprint estuvo orientado al diseño de una aplicación web capaz de presentar de forma clara los distintos modos de viaje y sus resultados asociados. Más que introducir nueva lógica de cálculo, la prioridad fue transformar el prototipo inicial en una interfaz más interpretable, útil para explorar escenarios y coherente con el objetivo del TFM como aplicación final.

El resultado fue una mejora progresiva de la usabilidad y de la lectura comparada de resultados, reforzando el valor del simulador no solo como demostración técnica, sino como herramienta de análisis y apoyo a la toma de decisiones sobre movilidad.
